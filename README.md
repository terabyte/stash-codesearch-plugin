...
Stash 3.X Build Status: [![Build Status](https://travis-ci.org/terabyte/stash-codesearch-plugin.svg?branch=stash%2F3.x%2Fbackports)](https://travis-ci.org/terabyte/stash-codesearch-plugin)
